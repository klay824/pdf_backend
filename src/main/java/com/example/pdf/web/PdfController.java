...
//        ConverterSvc.convertDocToByteArray();

        byte[] pdfBytes = new byte[] {37, 80, 68, 70, 45, 49, 46, 49, 10, 37, -62, -91, -62, -79, -61,
...
//        byte[] pdfBytes = pdfResponse.getBytes(StandardCharsets.UTF_8);
